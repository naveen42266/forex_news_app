    ...
    return (
        <div>
            ...
            <div className={`min-h-screen flex flex-col bg-gray-100 text-gray-900' transition-colors duration-300 hidden-scrollbar`}>
                <header className='sticky top-0 left-0 right-0 z-10 px-4 py-6 bg-primary text-white shadow-md'>
                ...
                <main className='container mx-auto px-4 py-6'>
                    <div className="text-lg pb-4 cursor-pointer"><span className="hover:text-slate-500" onClick={() => router.push('/')}>Home</span> {'>'} <span className="hover:text-slate-500">Admin</span></div>
                    <Card className="p-6 shadow-lg rounded-lg flex flex-col md:flex-row gap-6 bg-white">
                        ...
                        <div className="md:w-[50%]">
                            <div className=" bg-slate-200 flex flex-col items-center py-6">
                                ...
                                {/* User Details */}
                                <h2 className="text-3xl font-bold mt-4 font-mono">
                                    {user?.firstName} {user?.lastName}
                                </h2>
                                <p className="text-lg">Admin account</p>
                            ...
                            <div>
                                ...
                                {users! && users.map((user, index) => {
                                    return (
                                        <div key={index} className="flex justify-between items-center cursor-pointer hover:bg-slate-100 rounded-md p-4">
                                            <div className="flex justify-start items-center space-x-2">
                                                ...
                                                <div className="flex flex-col justify-between">
                                                    ...
                                                    <div className={`${user.type === "Admin" ? "text-red-500" : "text-green-500"} capitalize`}>{user?.type}</div>
                                                </div>
                                            </div>
                                            <ArrowForwardIosIcon />
                                        </div>
                        ...
                        <button
                            className="w-full bg-gray-200 py-2 rounded-md text-gray-700 hover:bg-gray-300 transition"
                        ...
                        <button
                            className="w-full bg-gray-200 py-2 rounded-md text-gray-700 hover:bg-gray-300 transition"
                            onClick={() => router.push("/account/statements")}
                        >
                            Statements and Documents
                        </button>
                        <button
                            className="w-full bg-red-500 py-2 rounded-md text-white hover:bg-red-600 transition"
