...
const Header: React.FC<HeaderProps> = ({ setOpen }) => {
    ...
    return (
        <div className="p-4 bg-primary text-white shadow-md sticky top-0">
            <ToastContainer />
            <div className="flex justify-between items-center">
                ...
                <div className='flex flex-row justify-end gap-4 items-center'>
                    ...
                    {user ? <div className='flex flex-row justify-end gap-4 items-center cursor-pointer hover:bg-slate-200 hover:text-gray-900 rounded-full px-3 py-2' onClick={() => setOpen(true)}>
                        ...
                        <button className={`px-3 pb-2 pt-1 text-white font-semibold hover:bg-gray-100 hover:text-black  rounded transition-colors duration-300`} onClick={() => router.push('/signIn')}>Login</button>}
